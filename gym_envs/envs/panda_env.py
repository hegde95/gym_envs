...
class PandaEnv(robot_env.RobotEnv):
    ...
    def _set_action(self, action):
        ...
        # arm_ctrl, gripper_ctrl = action[:7], action[7:8]

        # TODO: Do I need this function? Why not just regular step(self, action)?
    ...
    def _render_callback(self):
        ...
        site_id = self.sim.model.site_name2id('target0') # TODO: each derived env should have a target0
